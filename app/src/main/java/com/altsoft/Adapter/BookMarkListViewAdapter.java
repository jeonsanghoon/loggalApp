...
public class BookMarkListViewAdapter extends BaseAdapter {
    ...
    private ArrayList<T_MEMBER_BOOKMARK> listViewItemList = new ArrayList<T_MEMBER_BOOKMARK>() ;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        T_MEMBER_BOOKMARK listViewItem = listViewItemList.get(position);
        Glide.with(context)
    ...
    @Override
    public T_MEMBER_BOOKMARK getItem(int position) {
        return listViewItemList.get(position) ;
    }



    public Boolean SetDataBind(List<T_MEMBER_BOOKMARK> list) {
